...
BEGIN Scenario
    Name            EDT_Affect_of_using_EDT

BEGIN Epoch

    Epoch        1 Jan 2026 12:00:00.000000000
    SmartEpoch
	BEGIN	EVENT
			Epoch	1 Jan 2026 12:00:00.000000000
			EventEpoch
...
Start                   1 Jan 2026 12:00:00.000000000
Stop                    1 May 2026 12:00:00.000000000
    SmartInterval
	BEGIN	EVENTINTERVAL
			StartEvent
				BEGIN	EVENT
			...
			StopEvent
				BEGIN	EVENT
						Epoch	1 May 2026 12:00:00.000000000
						EpochState	Explicit
				END	EVENT
...
BEGIN Extensions
	...
	BEGIN	EVENTINTERVAL
			BEGIN Interval
				Start	10 May 2026 09:00:00.000000000
				Stop	11 May 2026 09:00:00.000000000
			END Interval
...
BEGIN Animation
    ...
    StartTime          1 Jan 2026 12:00:00.000000000
    EndTime            1 May 2026 12:00:00.000000000
    CurrentTime        1 Jan 2026 12:00:00.000000000
    Direction          Forward
...
BEGIN References
    Instance *
        *
    END Instance
    Instance Satellite/OFF_300km
        Satellite/OFF_300km
    END Instance
    Instance Satellite/OFF_500km
        Satellite/OFF_500km
    END Instance
    Instance Satellite/OFF_700km
        Satellite/OFF_700km
    END Instance
    Instance Satellite/OFF_900km
        Satellite/OFF_900km
    END Instance
    Instance Satellite/ON_300km
        Satellite/ON_300km
    END Instance
    Instance Satellite/ON_500km
        Satellite/ON_500km
    END Instance
    Instance Satellite/ON_700km
        Satellite/ON_700km
    END Instance
    Instance Satellite/ON_900km
        Satellite/ON_900km
    END Instance
END References
